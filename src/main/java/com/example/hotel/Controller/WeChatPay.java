...
//            String money="1";
            ...
            // 除去数组中的空值和签名参数
            packageParams = WeChatPay.paraFilter(packageParams);
            String prestr = WeChatPay.createLinkString(packageParams); // 把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
            ...
            // 将解析结果存储在HashMap中
            Map map = WeChatPay.doXMLParse(result);
